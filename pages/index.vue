              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    ><i class="far fa-clock" /> 2 mins</small>
                  ...
                  <li>
                    ...
                    ><i class="far fa-clock" /> 4 hours</small>
                    <div class="tools">
                      <i class="fas fa-edit" />
                      <i class="fas fa-trash-o" />
                    </div>
                  ...
                  <li>
                    ...
                    ><i class="far fa-clock" /> 1 day</small>
                    <div class="tools">
                      <i class="fas fa-edit" />
                      <i class="fas fa-trash-o" />
                    </div>
                  ...
                  <li>
                    ...
                    ><i class="far fa-clock" /> 3 days</small>
                    <div class="tools">
                      <i class="fas fa-edit" />
                      <i class="fas fa-trash-o" />
                    </div>
                  ...
                  <li>
                    ...
                    <small
                      class="badge badge-primary"
                    ><i class="far fa-clock" /> 1 week</small>
                    <div class="tools">
                      <i class="fas fa-edit" />
                      <i class="fas fa-trash-o" />
                    </div>
                  ...
                  <li>
                    ...
                    ><i class="far fa-clock" /> 1 month</small>
                    <div class="tools">
                      <i class="fas fa-edit" />
                      <i class="fas fa-trash-o" />
                    </div>
